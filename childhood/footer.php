        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <?php echo do_shortcode(
                    '[contact-form-7 id="376c159" title="Форма вопросов"]'
                ); ?>
                ...
                <div class="row align-items-center">
                    ...
                    <a href="<?php echo get_home_url(); ?>" class="footer__logo">
                        <img src="<?php echo wp_get_attachment_image_src(
                            ...
                            'full'
                        )[0]; ?>" alt="Мир детства" class="footer__logo-img">    
                    </a>    
                    </div>
...
<a href="<?php echo $inst['url']; ?>" target="<?php echo $inst[
    'target'
...
<a href="<?php echo $fb['url']; ?>" target="<?php echo $fb[
    'target'
]; ?>" class="footer__social-item">
...
<a href="<?php echo $yt['url']; ?>" target="<?php echo $yt[
    'target'
]; ?>" class="footer__social-item">
